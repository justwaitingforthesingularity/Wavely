...
export default function Settings() {
  ...
  const { user, loading: authLoading, login, signup, signInWithGoogle, logout, updateProfile, syncPull } = useAuth();
    ...
    <div className="fixed inset-0 z-[200] flex flex-col bg-[#0a0a0c]">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide px-6 pb-10">
        ...
        <button
          ...
          className="w-full py-3.5 rounded-xl bg-white/[0.06] border border-white/[0.08] hover:bg-white/[0.1] transition-colors flex items-center justify-center gap-3 mb-6"
        >
          ...
          <span className="text-[15px] font-medium text-white/80">Continue with Google</span>
        </button>
